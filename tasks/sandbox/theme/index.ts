import { TTheme, TThemes } from '@sandbox/ui'
...
const darkTheme: TTheme = {
  ...
  border: Colors.DARK_GRAY,
  foreground: Colors.DARK_DARK_GRAY,
  foregroundActive: Colors.DARK_GRAY,
  foregroundActiveHover: Colors.DARK_GRAY,
  foregroundActivePressed: Colors.DARK_GRAY,
  foregroundHover: Colors.DARK_DARK_GRAY,
  foregroundHoverTransparent: Colors.DARK_DARK_GRAY,
  foregroundPressed: Colors.DARK_DARK_GRAY,
  foregroundPressedTransparent: Colors.DARK_DARK_GRAY,
  foregroundTransparent: Colors.DARK_DARK_GRAY,
  iconActive: Colors.WHITE,
  iconActivePressed: Colors.WHITE,
