...
export const makeWorkspacesGithubReleases = async (logs: TWorkspacesLog[], prefixes: TPrefixes, workspacesOptions: TWorkspacesOptions, githubOptions: TGithubOptions) => {
