...
export const parseWorkspacesCommitMessage = (commitText: string, packageNames: string[], prefixes: TPrefixes, { autoNamePrefix }: TWorkspacesOptions): TWorkspacesParsedMessage | null => {
