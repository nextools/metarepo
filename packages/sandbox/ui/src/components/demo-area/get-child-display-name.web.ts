import { TComponentConfig, getChildrenKeys } from 'autoprops'
import { isUndefined } from 'tsfn'
import { getComponentName } from '../../utils'

export const getChildDisplayName = (componentConfig: TComponentConfig, childPath: readonly string[], currentChildIndex: number) => {
