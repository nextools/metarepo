...
export const applyDisableMutins = (values: BigInteger[], propName: string, propKeys: readonly string[], childrenKeys: readonly string[], mutinConfig: TCommonMutinConfig): void => {
