...
import { getResults } from './component-native-snapshots/get-results'

const checkComponentNativeSnapshots = async (files: string[]): Promise<void> => {
...
export const main = async () => {
  await checkComponentNativeSnapshots([
